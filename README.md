...
<p>This is a final project for C class graduation, where the user can convert units with ease.<br>
There are unit categories(mass, time, length and etc.) and sub units(kg, g, inch, second).</p>
<p>Unit data were acquired by web-scraping Wikipedia with the helper scripts & manual labor.</p>
<p>You can find the project here: <a href="http://gintautass.pythonanywhere.com/" target="_blank">link</a>. Currently don't work.</p>
